...
export const ALERTS: Alert[] = [
  ...
  { id: 'al3', type: 'info', title: 'Readiness Reminder — Haemovigilance Review', message: 'Your haemovigilance readiness review deadline is 30 June 2024. You have 82 days remaining.', date: '2024-04-08T09:00:00', read: true, targetRoles: ['staff'], category: 'Readiness' },
  { id: 'al4', type: 'danger', title: 'QC Follow-up Overdue — Staff Review Required', message: 'Sysmex WBC QC follow-up is due for update by 20 April 2024. Corrective notes are pending documentation.', date: '2024-04-08T14:00:00', read: false, targetRoles: ['supervisor'], category: 'QC Follow-up' },
  ...
  { id: 'al6', type: 'danger', title: 'Haemovigilance — Near Miss Investigation', message: 'Unlabelled FFP near-miss event logged on 07 April. Mandatory staff meeting scheduled for 10 April at 14:00.', date: '2024-04-07T16:30:00', read: false, targetRoles: ['hod', 'supervisor'], category: 'Haemovigilance' },
  ...
  { id: 'al9', type: 'warning', title: 'Readiness Gap — Emeka Okafor', message: 'Staff member Emeka Okafor has 2 overdue readiness checks (Sysmex XN-350 Operation, QMS Awareness). Supervisor follow-up required.', date: '2024-04-03T09:00:00', read: false, targetRoles: ['supervisor', 'hod'], category: 'Readiness' },

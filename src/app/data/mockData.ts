...
export const ALERTS: Alert[] = [
  { id: 'al1', type: 'danger', title: 'Critical Value — Hyperglycemia', message: 'Patient ID: L-26-0002 (Musa Danladi). Glucose = 350 mg/dL. Verification Required immediately.', date: '2026-05-09T08:42:00', read: false, targetRoles: ['staff', 'supervisor', 'hod'], category: 'Critical Values' },
  { id: 'al2', type: 'warning', title: 'Registry Queue — 5 Tests Pending', message: 'Chemistry bench: 5 orders have exceeded the 1-hour collection-to-entry target. Review backlog.', date: '2026-05-09T09:15:00', read: false, targetRoles: ['staff', 'supervisor'], category: 'LIMS Queue' },
  { id: 'al3', type: 'info', title: 'Validation Reminder', message: 'Supervisor verification is pending for 3 Haematology FBC results submitted by Adaeze Nwosu.', date: '2026-05-09T10:00:00', read: false, targetRoles: ['supervisor'], category: 'LIMS Registry' },
  { id: 'al4', type: 'danger', title: 'TAT Violation — Urgent Retic', message: 'Patient: Amara Okeke. Reticulocyte count has exceeded the 2-hour TAT limit. Investigate delay.', date: '2026-05-09T11:30:00', read: false, targetRoles: ['supervisor', 'hod'], category: 'Operational' },
  { id: 'al5', type: 'warning', title: 'Reagent Stock Low — Anti-D', message: 'Blood Bank: Anti-D reagent (Lot BB2402) inventory is below safety threshold. Reorder initiated.', date: '2026-05-09T08:00:00', read: false, targetRoles: ['staff', 'supervisor', 'hod'], category: 'Inventory' },
  { id: 'al6', type: 'success', title: 'System Synchronized', message: 'Cloud Registry sync completed successfully. All 124 local records are now live.', date: '2026-05-09T12:00:00', read: true, targetRoles: ['staff', 'supervisor', 'hod'], category: 'System' },
];

    ...
    <div className="kl-page">
      <section className="kl-premium-card mb-5 overflow-hidden bg-[var(--surface-card)] dark:bg-[linear-gradient(145deg,#0c0c0d,#19191b_52%,#2a2a2c)] p-5 text-[var(--text-primary)] dark:text-white sm:p-7 border border-[var(--surface-border)]">
        <div className="grid gap-5 lg:grid-cols-[1fr_360px]">
          <div>
            <p className="mb-4 inline-flex rounded-full border border-[var(--surface-border)] dark:border-white/12 bg-[var(--surface-raised)] dark:bg-white/8 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--text-secondary)] dark:text-white/68">Head of Department</p>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <button className="btn-primary" onClick={() => navigate('/hod/patients')}>Open patients</button>
              <button className="kl-button-soft rounded-full border border-[var(--surface-border)] dark:border-white/14 bg-[var(--surface-raised)] dark:bg-white/8 px-4 text-[var(--text-primary)] dark:text-white" onClick={() => navigate('/hod/reports')}>View reports</button>
              <button className="kl-button-soft rounded-full border border-[var(--surface-border)] dark:border-white/14 bg-[var(--surface-raised)] dark:bg-white/8 px-4 text-[var(--text-primary)] dark:text-white" onClick={() => openFloatingAI('Give me an executive-ready SOP, QC, and patient workload narrative.')}>Ask AI insights</button>
            </div>
          </div>

      ...
      <div className="space-y-3">
        ...
        {filtered.map(sop => (
          <button
            ...
            className="w-full bg-white border border-[#d3def5] rounded-[20px] p-5 flex items-start gap-4 hover:border-[var(--primary)] hover:shadow-[0px_6px_18px_rgba(28,94,255,0.08)] transition-all group"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3 mb-1">
                <h3 className="text-[#11203b] font-semibold text-[15px] leading-snug group-hover:text-[var(--primary)] transition-colors break-word">
                  {sop.title}
                </h3>
                <ChevronRight size={16} className="text-[#c4d2ef] group-hover:text-[var(--primary)] flex-shrink-0 mt-0.5 transition-colors" />
              </div>
              ...
              <p className="text-[#475a7d] text-[13px] line-clamp-2 leading-relaxed break-word">{sop.purpose}</p>
